...
D.append("""## Table S8(B). Day-1 performance among all admissions (severity frame)
...
D.append("## Table S5. Observed-data availability and scorability\n\n" + """
...
D.append("## Table S11. Subgroup discrimination and calibration (landmark; source: fairness_subgroups_lm24.csv)\n\n" + md(fair) + """
...
D.append("## Table S9. Redevelopment sensitivity analyses\n\n" + """
