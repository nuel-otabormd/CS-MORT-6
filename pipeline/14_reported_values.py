...
# ---- availability at the exact 24-hour landmark (Supplementary Table S5(A)) ----
...
# ---- internal deployment-rule rescoring (Supplementary Table S7(A)) ----
...
# ---- worked example (Supplementary Table S3(A)) ----
