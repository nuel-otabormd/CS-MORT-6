# Missingness analysis (Reviewer 2.2/2.1): both perfusion variables MNAR (opposite
...
print("\n"+"="*68); print("2. DISCRIMINATION STRATIFIED by lactate measured/missing (Reviewer 2.2)")
print("="*68)
